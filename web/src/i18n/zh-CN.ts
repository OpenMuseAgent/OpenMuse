...
const zhCN: Record<string, string> = {
  ...
  "{feeds} calendars · {n} events": "{feeds} 个日历 · {n} 个日程",
  ...
  "{n} events · read {when}": "{n} 个日程 · {when}读取",
  "not read yet": "尚未读取",

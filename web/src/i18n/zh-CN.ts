...
const zhCN: Record<string, string> = {
  ...
  Connections: "连接",
  "Model, email, browser, MCP servers": "模型、邮件、浏览器、MCP 服务器",
  Settings: "设置",
  ...
  "Connect your mail": "连接你的邮箱",
  "Optional. With a mailbox connected it can read what came in and draft replies; it will always ask before sending. The browser and MCP servers are under Connections later.":
    "可选。连接邮箱后它可以读取新邮件并起草回复；发送前总会先询问你。浏览器和 MCP 服务器稍后可在“连接”中设置。",
